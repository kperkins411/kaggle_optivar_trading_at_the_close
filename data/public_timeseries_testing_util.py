...
class MockApi:
    def __init__(self):
        ...
        '''
        self.input_paths: Sequence[str] =['./data/example_test_files/test.csv','./data/example_test_files/revealed_targets.csv','./data/example_test_files/sample_submission.csv']
